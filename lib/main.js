...
module.exports = {
  ...
  event(e) {
    ...
    // menu dispatches at whatever holds focus, while the registry keeps the
    // target lookup realm-safe and excludes mini editors.
    this.update(
      lumine.textEditors.getTextEditorForElement(this.target, { includeMini: false }) ??
