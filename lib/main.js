...
module.exports = {
  ...
  event(e) {
    ...
    // menu dispatches at whatever holds focus, while the resolver excludes
    // mini editors from target lookup.
    this.update(
      lumine.workspace.getTextEditorForElement(this.target, { includeMini: false }) ??
